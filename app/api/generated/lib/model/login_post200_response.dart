...
class LoginPost200Response {
  ...
  /// CSRF Token required for following POST requests.
  ///
  /// Please note: This property should have been non-nullable! Since the specification file
  /// does not include a default value (using the "default:" property), however, the generated
  /// source code must fall back to having a nullable type.
  ...
  /// Boolean indicating if the player needs to create a username.
  ///
  /// Please note: This property should have been non-nullable! Since the specification file
  /// does not include a default value (using the "default:" property), however, the generated
  /// source code must fall back to having a nullable type.
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.userCreationRequired != null) {
      json[r'userCreationRequired'] = this.userCreationRequired;
    } else {
      json[r'userCreationRequired'] = null;
    }
  ...
  static LoginPost200Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return LoginPost200Response(
        ...
        userCreationRequired: mapValueOfType<bool>(json, r'userCreationRequired'),
