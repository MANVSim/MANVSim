...
Revision ID: 1c84412fffa4
Revises: 
Create Date: 2024-08-19 11:03:18.551979
...
def upgrade():
    ...
    op.create_table('resource_quantity_in_location',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('quantity', sa.Integer(), nullable=False),
    sa.Column('location_id', sa.Integer(), nullable=False),
    sa.Column('resource_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['location_id'], ['location.id'], name=op.f('fk_resource_quantity_in_location_location_id_location')),
    sa.ForeignKeyConstraint(['resource_id'], ['resource.id'], name=op.f('fk_resource_quantity_in_location_resource_id_resource')),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_resource_quantity_in_location'))
    )
...
def downgrade():
    ...
    op.drop_table('resource_quantity_in_location')
