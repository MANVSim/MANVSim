...
Revision ID: 454cd575bc25
Revises: 
Create Date: 2024-09-20 12:11:07.484716
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['location_id'], ['location.id'], name=op.f('fk_patient_in_scenario_location_id_location')),
